...
Deze map bevat legacy documentatie en voorbeeldconfigs die niet meer de standaard productieroute zijn.

Gebruik voor actieve implementaties altijd de hoofdmap `docs/`.
