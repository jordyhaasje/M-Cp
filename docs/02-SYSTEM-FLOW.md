...
2. Lees voor `new_section` bij voorkeur exact de planner-provided `nextReadKeys` in één compacte `get-theme-files` call. Daardoor ziet de LLM vooraf de relevante section/snippet helpers en wrappers zonder brede wildcard reads te doen.
