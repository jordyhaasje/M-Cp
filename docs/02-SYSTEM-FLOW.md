...
6. Live of ander target toepassen gebeurt via `apply-theme-draft` met expliciete confirmation. Deze tool is nooit de eerste write-stap voor een nieuwe section.
