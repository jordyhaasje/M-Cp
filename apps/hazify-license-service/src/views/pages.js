...
<head>
  ...
  <style>
    @import url("https://fonts.googleapis.com/css2?family=Syne:wght@500;600;700;800&family=Manrope:wght@500;600;700;800&family=IBM+Plex+Mono:wght@400;500&display=swap");
    ...
    :root {
      ...
      --radius-lg: 18px;
      --radius-md: 14px;
      --shadow-page: 0 14px 34px rgba(15, 23, 42, 0.08);
      --shadow-card: 0 10px 22px rgba(15, 23, 42, 0.06);
      --shadow-hover: 0 16px 28px rgba(15, 23, 42, 0.1);
      --focus-ring: #245fb7;
    ...
    * { box-sizing: border-box; }
    ...
    body {
      ...
      color: var(--text);
      background:
        radial-gradient(920px 360px at 112% -12%, rgba(20, 20, 24, 0.04), transparent 70%),
        radial-gradient(700px 360px at -22% 108%, rgba(56, 58, 64, 0.06), transparent 72%),
    ...
    .quick-connect-item.active .setup-btn {
      background: var(--brand);
      border-color: var(--brand);
      color: var(--brand-contrast);
    }
    ...
    :root {
      ...
      --warn: #8a6705;
      --danger: #b42318;
      --shadow-page: 0 16px 40px rgba(7, 18, 38, 0.08);
      --shadow-card: 0 10px 24px rgba(7, 18, 38, 0.07);
      --shadow-hover: 0 16px 30px rgba(7, 18, 38, 0.12);
      --focus-ring: #0c58c5;
    ...
    body {
      background:
        radial-gradient(1200px 560px at 94% -24%, rgba(17, 47, 97, 0.12), transparent 72%),
        radial-gradient(900px 560px at -16% 110%, rgba(16, 33, 66, 0.1), transparent 74%),
    ...
    .topbar {
      ...
      box-shadow: 0 12px 24px rgba(6, 17, 34, 0.08);
    }
    ...
    .hero {
      ...
      gap: 20px;
      background:
        linear-gradient(165deg, rgba(255, 255, 255, 0.98) 0%, rgba(246, 250, 255, 0.92) 100%);
    ...
    .onboarding-cards .start-card:last-child {
      border-right: 0;
    }
    ...
    .btn:hover {
      transform: translateY(-1px);
      border-color: #afbdd2;
      box-shadow: 0 12px 20px rgba(8, 18, 36, 0.11);
    }

    .btn.primary {
      background: linear-gradient(180deg, #0b0f18 0%, #06080d 100%);
      border-color: #06080d;
      color: #ffffff;
      box-shadow: 0 14px 22px rgba(4, 8, 14, 0.28);
    }

    .btn.primary:hover {
      box-shadow: 0 16px 28px rgba(4, 8, 14, 0.34);
    }

    .btn.soft {
      background: linear-gradient(180deg, #f9fbff 0%, #f0f5fd 100%);
      color: #182940;
    }
    ...
    .progress-meter > span {
      background: linear-gradient(90deg, #0f1930 0%, #1d335c 100%);
    }
    ...
    .progress-step.done {
      background: #f3fbf7;
      border-color: rgba(15, 122, 78, 0.32);
    }
    ...
    .connect-tab.active {
      background: #ffffff;
      color: #0f1e36;
      box-shadow: 0 8px 16px rgba(12, 24, 46, 0.12);
    }
    ...
    .quick-connect-item.active {
      ...
      box-shadow: 0 12px 20px rgba(15, 35, 70, 0.11);
    }
    ...
    .store-item.active {
      border-color: #92a7c8;
      box-shadow: 0 14px 22px rgba(11, 28, 57, 0.12);
    ...
    .modal-backdrop {
      background:
        radial-gradient(860px 380px at 10% 8%, rgba(57, 82, 122, 0.22), transparent 68%),
        radial-gradient(860px 380px at 90% 92%, rgba(20, 38, 68, 0.28), transparent 68%),
        rgba(5, 10, 18, 0.44);
    }
    ...
    .modal {
      ...
      box-shadow: 0 34px 68px rgba(5, 12, 23, 0.38);
    }
    ...
    .discord-logo-link {
      ...
      box-shadow: 0 10px 20px rgba(8, 20, 38, 0.1);
    }
      ...
      <div class="page">
        <section class="section animate-in onboarding-section">
          <div class="hero onboarding-hero">
            ...
            <h2>Enterprise-grade AI tooling voor jouw Shopify operatie.</h2>
            <p class="lead">Log in, verbind je winkel en activeer direct de remote MCP-route voor je favoriete AI clients.</p>
            ${logoStrip()}
          </div>
  ...
  return shell({
    ...
    body: `
      <div class="page">
        ...
        <section class="section animate-in">
          <div class="hero">
            <h2>Jouw AI command center voor Shopify.</h2>
            <p class="lead">Beheer winkels, activeer koppelingen en monitor setup-status in een strakke, production-ready flow.</p>
            ${logoStrip()}
          </div>
            ...
            <div class="grid-2" style="align-items:start;">
              ...
              <article class="panel">
                ...
                <div class="connect-tabs" id="connectTabs" role="tablist" aria-label="App setup type">
                  <button class="connect-tab active" id="connectTabQuick" type="button" role="tab" data-connect-tab="quick" aria-selected="true" aria-controls="connectPaneQuick" tabindex="0">Snelle setup</button>
                  <button class="connect-tab" id="connectTabOther" type="button" role="tab" data-connect-tab="other" aria-selected="false" aria-controls="connectPaneOther" tabindex="-1">Andere apps</button>
                  <button class="connect-tab" id="connectTabHelp" type="button" role="tab" data-connect-tab="help" aria-selected="false" aria-controls="connectPaneHelp" tabindex="-1">Help</button>
                </div>

                <div class="connect-pane" id="connectPaneQuick" role="tabpanel" aria-labelledby="connectTabQuick" data-connect-pane="quick" aria-hidden="false">
                ...
                <div class="connect-pane hidden" id="connectPaneOther" role="tabpanel" aria-labelledby="connectTabOther" data-connect-pane="other" aria-hidden="true">
                ...
                <div class="connect-pane hidden help-pane" id="connectPaneHelp" role="tabpanel" aria-labelledby="connectTabHelp" data-connect-pane="help" aria-hidden="true">
                  <div class="setup-list">
                    <article class="setup-item">
                      <div class="setup-item-left">
      ...
      <script>
        ...
        const notice = document.getElementById('notice');
        const noticeLive = document.getElementById('noticeLive');
        ...
        function setNotice(type, message) {
          ...
          if (noticeLive) {
            ...
            window.setTimeout(() => {
              noticeLive.textContent = message;
            }, 30);
          }
        }
        ...
        function markSelectedClient(client) {
          ...
          connectGrid.querySelectorAll('.quick-connect-item').forEach((row) => {
            const active = row.dataset.quickClient === client;
            row.classList.toggle('active', active);
            row.setAttribute('aria-current', active ? 'true' : 'false');
            const actionButton = row.querySelector('button[data-connect]');
            if (actionButton) {
              actionButton.classList.toggle('primary', active);
            }
          });
        }
        ...
        function updatePanePrimaryAction(activePaneKey) {
          const quickPane = document.querySelector('[data-connect-pane="quick"]');
          const otherPane = document.querySelector('[data-connect-pane="other"]');
          const helpPane = document.querySelector('[data-connect-pane="help"]');
          [quickPane, otherPane, helpPane].forEach((pane) => {
            if (!pane) return;
            pane.querySelectorAll('.setup-btn').forEach((button) => {
              button.classList.remove('primary');
            });
          });

          if (activePaneKey === 'quick') {
            markSelectedClient(state.selectedClient || 'vscode');
            return;
          }

          const pane = activePaneKey === 'help' ? helpPane : otherPane;
          const primaryButton = pane ? pane.querySelector('.setup-btn') : null;
          if (primaryButton) {
        ...
        function setConnectTab(nextTab) {
          ...
          connectPanes.forEach((pane) => {
            const active = pane.getAttribute('data-connect-pane') === safeTab;
            pane.classList.toggle('hidden', !active);
            pane.setAttribute('aria-hidden', active ? 'false' : 'true');
          });
          updatePanePrimaryAction(safeTab);
        }
        ...
        function closeSetupModal() {
          ...
          focusElementSafely(lastSetupTrigger);
          lastSetupTrigger = null;
        }
        ...
        function renderSetupModal(guide) {
          ...
          focusElementSafely(setupCopyBtn);
        }
        ...
        function closeStoreDetailsModal() {
          ...
          focusElementSafely(lastStoreTrigger);
          lastStoreTrigger = null;
        }
        ...
        function openStoreDetailsModal(tenantData = null) {
          ...
          focusElementSafely(storeModalDoneBtn);
        }
        ...
        function renderStoreList(tenants = [], activeTenantId = '') {
          if (!Array.isArray(tenants) || !tenants.length) {
            storeList.innerHTML =
              ...
              '<h4>Nog geen winkel gekoppeld</h4>' +
              '<p>Koppel je Shopify-winkel om MCP setup en app-connecties te starten.</p>' +
              '<button class="btn primary" type="button" data-empty-action="connect-shop">Winkel koppelen</button>' +
              '</section>';
            return;
          }
        ...
        function renderActiveConnections(rows = []) {
          ...
          if (!normalizedRows.length) {
            activeConnections.innerHTML =
              '<section class="empty-state">' +
              '<h4>Nog geen actieve koppelingen</h4>' +
              '<p>Open Snelle setup of Andere apps om direct een client te verbinden.</p>' +
              '<button class="btn primary" type="button" data-empty-action="open-setup">Start setup</button>' +
              '</section>';
            return;
          }
        ...
        connectTabs.addEventListener('keydown', (event) => {
          const tabs = Array.from(connectTabs.querySelectorAll('button[data-connect-tab]'));
          ...
          setConnectTab(nextTab.getAttribute('data-connect-tab') || 'quick');
          focusElementSafely(nextTab);
        });
        ...
        storeList.addEventListener('click', async (event) => {
          const emptyActionButton = event.target.closest('button[data-empty-action="connect-shop"]');
          if (emptyActionButton) {
            focusElementSafely(document.getElementById('shopDomain'));
            setNotice('warn', 'Vul je shopdomein in en klik op "Winkel opslaan".');
            return;
          }
        ...
        activeConnections.addEventListener('click', async (event) => {
          const emptyActionButton = event.target.closest('button[data-empty-action="open-setup"]');
          if (emptyActionButton) {
            setConnectTab('quick');
            const preferredButton = connectGrid.querySelector('.quick-connect-item.active .setup-btn') ||
              connectGrid.querySelector('.setup-btn');
            focusElementSafely(preferredButton);
            setNotice('ok', 'Kies een app en rond de setup af.');
            return;
          }
