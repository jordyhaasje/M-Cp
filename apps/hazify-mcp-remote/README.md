...
- `draft-theme-artifact` stuurt exacte comparison/shell replica's nu ook terug wanneer ze onderscheidende referentie-anchors zoals floating productmedia of badges/seals laten vallen, of wanneer ze een dubbele background-shell opbouwen via een eigen root background plus een theme wrapper-helper.
