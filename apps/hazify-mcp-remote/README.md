...
- Wanneer in dezelfde flow net een section is aangemaakt, blijft dat bestand nu sticky voor vervolgprompts zoals `optimaliseer hem`, `maak V2` of `verbeter die section`, tenzij de gebruiker expliciet van target wisselt.
