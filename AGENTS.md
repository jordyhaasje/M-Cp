...
3. Gebruik voor native product-blocks, theme blocks en template placement eerst `plan-theme-edit`, en lees/schrijf daarna alleen de exact voorgestelde files.
...
6. Gebruik `apply-theme-draft` alleen wanneer een eerder draft expliciet naar een ander theme gepromoot moet worden.
